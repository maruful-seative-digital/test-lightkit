...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-center w-full h-[calc(100vh-52.25px)] flex-col">
      ...
      <p className="mt-1 text-small text-text-2">Hey there, welcome back 💖</p>

      {/* form wrapper */}
      <div>
        <form onSubmit={handleLogin} className="mt-4 w-80">
          <div className="mb-4">
            <label
              htmlFor="email"
          ...
          <div className="mb-4">
            <Link
              ...
              className="font-medium underline text-small text-text-2"
            >
              Forgot Password?
            </Link>
          </div>
        ...
        <div className="flex items-center justify-center gap-1 mt-8 text-large">
          <p className="font-medium text-text-2">New User?</p>
          <Link to="/signup" className="font-semibold border-b border-white">
            Create Account
          </Link>
        </div>
      </div>
